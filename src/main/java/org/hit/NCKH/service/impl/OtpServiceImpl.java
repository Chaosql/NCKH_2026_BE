...
import org.hit.NCKH.domain.dto.common.DataMailDto;
import org.hit.NCKH.exception.InvalidException;
import org.hit.NCKH.service.OtpService;
import org.hit.NCKH.util.SendMailUtil;
...
public class OtpServiceImpl implements OtpService {
    ...
    public String generateOtp(String email) {
        ...
        redisTemplate.opsForValue().set("OTP:" + email, otpCode, 3, TimeUnit.MINUTES);
        return otpCode;
    }
    ...
    public void sendOtp(String email, String otpCode) {
        try {
            ...
            try {
                subject = messageSource.getMessage("mail.otp.subject", null, LocaleContextHolder.getLocale());
            } catch (Exception e) {
                log.warn("Message source not found for mail.otp.subject, using default.");
            }
